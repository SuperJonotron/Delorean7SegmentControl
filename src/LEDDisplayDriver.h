...
/* Don't remember exactly why this is needed
 * but without it, this won't compile for 
 * these boards.  Something with a conflict in
 * the way min is defined in arduino.h I think.
 */
...
// #define _min std::min(a,b)
// #define _min std::max(a,b)
// #endif 
